            ...
            <React.Fragment>
                ...
                <div id="tourdates_component" className="parallax__group">
                    <div className="parallax__layer_tourdates parallax__layer--fore">
                        ...
                        <section id="contact">
                            <h2>Contact</h2>
                            <p>Telephone: ENTER NUMBER HERE</p>
                        ...
                        <section id="disclaimer">
                            ...
                            <p>
                                ...
                                content on these web pages. In this context,
                                please note that we are accordingly not obliged
                                to monitor merely the transmitted or saved
                                ...
                                remain unaffected by this as per §§ 8 to 10 of
                            ...
                            <p>
                                ...
                                by law (§ 44a et seq. of the copyright law),
                                every form of utilizing, reproducing or
                                ...
                                reproductions of a work are allowed only for
                                private use, so must not serve either directly
                                or indirectly for earnings. Unauthorized
                                utilization of copyrighted works is punishable
